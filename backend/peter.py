...
createAccidentCSV("vic_accident_working.csv", mgrid, "death", "death.csv", expsquares=1)
createAccidentCSV("vic_accident_working.csv", mgrid, "injured", "injury.csv", expsquares=1)
createAccidentCSV("vic_accident_working.csv", mgrid, "accident", "accident.csv", expsquares=1)
loadField(mgriddeaths, "death.csv")
loadField(mgridinjury, "injury.csv")
loadField(mgridcrash, "accident.csv")
...
steps = [(pointsonpath[0][0], pointsonpath[0][1], 0.0)] #start with our start point at distance 0
for i in range(0, len(pointsonpath)-1):
    a = pointsonpath[i]
    b = pointsonpath[i+1]
